...
* The [Single Drug Response Predictor (P1B3)](https://modac.cancer.gov/searchTab?dme_data_id=NCI-DME-MS01-8308552) asset contains the untrained model and trained model:
  ...
  * The trained model is defined by combining the untrained model and model weights. &#x1F534;_**(Question: Is there a filename for the untrained model and a filename for the untrained model weights?)**_
  * The trained model weights (p1b3.model.h5) are used in inference.
